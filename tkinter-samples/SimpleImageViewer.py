...
image_no_1 = ImageTk.PhotoImage(Image.open("./images/1.jpg"))
image_no_2 = ImageTk.PhotoImage(Image.open("./images/2.jpg"))
image_no_3 = ImageTk.PhotoImage(Image.open("./images/3.jpg"))
image_no_4 = ImageTk.PhotoImage(Image.open("./images/4.jpg"))
